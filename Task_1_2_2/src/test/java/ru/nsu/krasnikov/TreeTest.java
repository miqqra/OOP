...
public class TreeTest {
    ...
    public void testParent() {
        ...
        Tree<Integer> node2 = tree.add(2);
        Tree<Integer> node3 = tree.add(tree, 3);
        Assertions.assertEquals(tree, node3.getParent());
        Tree<Integer> node4 = tree.add(new Tree<>(4));
        Assertions.assertEquals(tree, node4.getParent());
        Tree<Integer> node5 = tree.add(5);
        Assertions.assertEquals(tree, node5.getParent());
        Assertions.assertEquals(tree, tree.getParent(5));
        Tree<Integer> node6 = node2.add(6);
        Assertions.assertEquals(node2, node6.getParent());
        ...
        Tree<Integer> node9 = node7.add(9);
        Assertions.assertEquals(node7, node9.getParent());
    ...
    @Test
    public void testFindNodesAndSubtrees() {
        Tree<Integer> tree = new Tree<>();
        tree.add(1);
        Tree<Integer> node2 = tree.add(2);
        Tree<Integer> node3 = tree.add(tree, 3);
